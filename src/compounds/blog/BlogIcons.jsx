...
const Blog = () => {
  return (
    <>
      <section className="bg-white pb-10 pt-20 w-full xl:w-full md:w-full sm:w-full lg:w-full dark:bg-dark lg:pb-20 lg:pt-[120px]">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto mb-[60px] max-w-[510px] text-center items-center justify-center lg:mb-20">
